...
for aluno, respostas in alunos.items():
    ...
    print(f"O aluno {aluno} obteve {acertos} acertos dentre {numero_de_questoes} questões e ficou com a nota {nota:.2f}")
...
print(f"O aluno com o mais acertos é {aluno_com_maior_acerto}, com {maior_acerto} acertos \nO aluno com o menos acertos é {aluno_com_menor_acerto}, com {menor_acerto} acertos \nA média da turma é {media_da_turma:.2f}")